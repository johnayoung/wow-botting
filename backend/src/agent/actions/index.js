...
const bloodlust = require('./bloodlust');
...
const fireBlast = require('./fire-blast');
const flameShock = require('./flame-shock');
...
const powerWordFortitude = require('./fortitude');
...
const wyvernSting = require('./wyvern-sting');
